...
const LoginPage = () => {
  ...
  useEffect(() => {
    console.log("STEP 3 → authUser:", authUser);
    console.log("STEP 3 → authUser role:", authUser?.role);
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800">Eduacational project management</h1>
        ...
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input type="password" name="password" value={formData.password} onChange={handleChange} className={`input ${errors.email ? "input-error" : ""}`} placeholder="Enter your password" />
              {
                errors.password && (
